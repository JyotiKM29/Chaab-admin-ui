...
// const COLORS = ['#0088FE', '#00C49F', '#FFBB28', '#FF8042', '#8884d8'];
// const HOVER_COLORS = ['#B4CEFF', '#B4D7E8', '#B4E5FF', '#B4F4FF', '#B4FFF0'];

// const DonutChart = () => {
//   const [activeBrowser, setActiveBrowser] = useState(null);

//   const handleClick = (data) => {
//     setActiveBrowser(data.name);
//   };
...
//           stroke="grey"
//           strokeOpacity={0.3}
//           filter="url(#donutChartShadow)"
//         >
//           {data.map((entry, index) => (
//             <Cell
//               key={`cell-${index}`}
//               fill={
//                 activeBrowser === entry.name ? HOVER_COLORS[index % HOVER_COLORS.length] : 'white'
//               }
//               onMouseEnter={() => handleMouseEnter(index)}
//               onMouseLeave={handleMouseLeave}
//             />
